...
<tr>
	...
	<td>
		<a href="{!! route('kategori_berita.show',[$item->id])!!}" class="btn btn-sm btn-dark">lihat </a>
		<a href="{!! route('kategori_berita.edit',[$item->id])!!}" class="btn btn-sm btn-primary">ubah</a>
