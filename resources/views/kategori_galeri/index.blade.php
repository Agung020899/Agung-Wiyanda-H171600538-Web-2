...
<tr>
	...
	<td>
		<a href="{!! route('kategori_galeri.show',[$item->id])!!}" class="btn btn-sm btn-dark">lihat </a>
		<a href="{!! route('kategori_galeri.edit',[$item->id])!!}" class="btn btn-sm btn-primary">ubah</a>
